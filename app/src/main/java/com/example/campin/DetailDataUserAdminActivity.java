...
public class DetailDataUserAdminActivity extends AppCompatActivity {
    ...
    EditText ETNamaPengguna,ETNamaLengkap,ETNik,ETNohp,ETEmail,ETKataSandi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ETNik                = findViewById(R.id.ETUp_nik_profil);
            ...
            new AlertDialog.Builder(DetailDataUserAdminActivity.this)
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            AndroidNetworking.post("https://tkjbpnup.com/kelompok_8/hapususer.php")
