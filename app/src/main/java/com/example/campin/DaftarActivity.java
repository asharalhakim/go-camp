...
public class DaftarActivity extends AppCompatActivity {
    ...
    EditText ETDnama_lengkap, ETDnama_pengguna, ETDnik, ETDno_handphone, ETDemail, ETDkata_sandi;
    String nama_lengkap, nama_pengguna, nik, nohp, email, kata_sandi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ETDnik = findViewById(R.id.ETDnik);
        ...
        ETDnik.animate().translationX(0).alpha(1).setDuration(1000).setStartDelay(150).start();
    ...
    void validasiData(){
        ...
        if(nama_lengkap.equals("") || nama_pengguna.equals("") || nik.equals("") || nohp.equals("") || email.equals("") || kata_sandi.equals("")){
    ...
    void kirimData(){
        ...
        AndroidNetworking.post("https://tkjbpnup.com/kelompok_8/register.php")
