...
public class List_Alat_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ic_kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(List_Alat_Activity.this,BerandaActivity.class);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            if(status){
                                ...
                                final CLV_Alat adapter = new CLV_Alat(List_Alat_Activity.this,array_nama_staff,array_id_staff,
...
//                                });
                                ...
                                Toast.makeText(List_Alat_Activity.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
